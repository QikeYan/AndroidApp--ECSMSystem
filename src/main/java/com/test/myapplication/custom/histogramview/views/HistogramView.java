package com.test.myapplication.custom.histogramview.views;
...
import com.test.myapplication.custom.histogramview.util.DisplayUtil;
...
//    private static final String[] DEFAULT_DATE_TEXT = new String[]{"一", "二", "三", "四", "五", "六", "日"};
    private static final String[] DEFAULT_DATE_TEXT = new String[]{"Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"};
...
//                if (d != 0)
                view.setShowText(String.valueOf(d)+"kw");
            } else {
                view.setRatio(0);
                // 全部为0则不显示数字
